  ...
  return (
    <div name='home' className='w-full h-screen bg-[#1f1f29]'>
      ...
      <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
        ...
        I’m a full-stack web developer with a passion for design. I enjoy creating functional and accessible nice looking websites with a focus on responsiveness and cleanness. 
        I’m currently focused on building responsive full-stack web applications.
        </p>
        <div>
